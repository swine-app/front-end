...
import { Box, Button, Flex, FormControl, FormErrorMessage, Input, Text, useToast } from "@chakra-ui/react";
    ...
    <Flex width="100vw" height="100vh" alignItems="center" justifyContent="center" >
      <form onSubmit={handleSubmit(onSubmit)} >
          ...
          >
            ...
            <Box color="red">
              {Object.entries(errors).reduce((accum, [key, value]) => value.type === "required" ? `${accum} ${key} is required` : accum, "")}
            </Box>
